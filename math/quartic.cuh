...
inline __host__ __device__ float2  quartic(float2 v)  { return v*v*(2.0f-v*v); }
inline __host__ __device__ float3  quartic(float3 v)  { return v*v*(2.0f-v*v); }
inline __host__ __device__ float4  quartic(float4 v)  { return v*v*(2.0f-v*v); }
