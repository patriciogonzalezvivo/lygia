...
inline __device__ __host__ float mmax(float2 v) { return max(v.x, v.y); }
inline __device__ __host__ float mmax(float3 v) { return mmax(v.x, v.y, v.z); }
inline __device__ __host__ float mmax(float4 v) { return mmax(v.x, v.y, v.z, v.w); }
