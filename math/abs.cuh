...
inline __host__ __device__ float2 abs(float2 v) { return make_float2(fabs(v.x), fabs(v.y)); }
inline __host__ __device__ float3 abs(float3 v) { return make_float3(fabs(v.x), fabs(v.y), fabs(v.z)); }
inline __host__ __device__ float4 abs(float4 v) { return make_float4(fabs(v.x), fabs(v.y), fabs(v.z), fabs(v.w)); }
