...
vec3 specularCookTorrance(const in vec3 L, const in vec3 N, const in vec3 V, const in vec3 H, const in float NoV, const in float NoL, const in float NoH, const in float roughness, const in vec3 specularColor) {
