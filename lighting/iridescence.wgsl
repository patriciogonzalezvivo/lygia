#include "../color/palette/hue.wgsl"
...
fn iridescence(cosA: f32, thickness: f32) -> vec3f {
    ...
    let tint = vec3f(0.7333,0.89804,0.94902);
    ...
    let f = (NxV) * (NxV);
    let interf = mix(interf0, interf1, f);
    let phase = mix(phase0, phase1, f);
    let dp = (NxV + 1.0) * 0.5;
    ...
    let film = hue * lum + vec3f(0.49639,0.78252,0.88723) * luma;
